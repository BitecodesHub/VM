...
export const TEMPLATES = {
  ...
  'linux-desktop': {
    ...
    ports: [{ role: 'ui', containerPort: 6901, range: [6201, 6299] }, { role: 'audio', containerPort: 4901, range: [4911, 4999] }],
...
export function mapContainerToCard(inspect) {
  ...
  if (adopted) {
    ...
    if (adopted.media) card.audioPort = hostPortFor(inspect, 4901) || null;
